...
if selected == "Home":
    ...
    with col1:
        header = st.image("rs1.jpeg", caption=" ", use_column_width=True,)
        st.write("ONEW MEDICAL CENTER(jalan Mlatiharjo 1 no.431A, Mlatibaru, Semarang Timur, Kota Semarang, Jawa Tengah)")
    with col2:
...
if selected == "Formulir Pendaftaran Pasien":
    ...
    with col1:
        header = st.image("rs onew.jpg", width="500", use_column_width=True)
